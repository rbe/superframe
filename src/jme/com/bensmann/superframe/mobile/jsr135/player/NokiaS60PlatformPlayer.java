/*
 * com/bensmann/mobile/jsr135/NokiaS60PlatformPlayer.java
 *
 * NokiaS60PlatformPlayer.java created on 3. Februar 2007, 23:48 by rb
 *
 ...
 * @version 1.0
 */
public class NokiaS60PlatformPlayer extends AbstractPlatformPlayer {
    
    /**
     * Creates a new instance of NokiaS60PlatformPlayer
     */
    public NokiaS60PlatformPlayer() {
        encoding = "png";
    }
    ...
    public byte[] getSnapshot() throws Jsr135Exception {
        ...
        try {
            return videoControl.getSnapshot(getEncodingString());
        } catch (MediaException e) {
            throw new Jsr135Exception(e.toString());
        }
