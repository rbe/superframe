...
public class ClassUtil {
     ...
     * @return
     */
    public static <E> Constructor<E> findConstructor(Class<E> clazz, Class<?>... argumentTypes)
        ...
        try {
            ...
            throw new ReflectionException("Cannot find requested constructor", e);
        }
     ...
     * @return
     */
    public static Method findMethodByName(Class<?> clazz, String methodName, boolean ignoreCase) {
     ...
     * @return
     */
    public static Method getGetterMethodByName(Class clazz, String fieldName, boolean ignoreCase) {
     ...
     * @return
     */
    public static Method getSetterMethodByName(Class clazz, String fieldName, boolean ignoreCase) {
     ...
     * @return 
     */
    public static Field[] getFields(Class clazz, boolean haveModifier, int... modifiers) {
     ...
     * @return 
     */
    public static Method[] getMethods(Class clazz, boolean haveModifier, int... modifiers) {
     ...
     */
    public static Object getFieldValue(Field field, Object object) throws ReflectionException {
        Object value = null;
        int modifier = 0;
        Method method = null;
        ...
        if (Modifier.isPublic(modifier)) {
            ...
            method = getGetterMethodByName(object.getClass(), field.getName(), false);
            try {
        ...
        if (!gotViaPublic && !gotViaAccessor) {
            throw new ReflectionException("Could not get value from field " + field.getName());
        }
        return value;
    ...
    public static Class<?> getFieldType(Class clazz, String fieldName)
        ...
        try {
            ...
            throw new ReflectionException("Security: cannot access field " + fieldName, e);
        } catch (NoSuchFieldException e) {
