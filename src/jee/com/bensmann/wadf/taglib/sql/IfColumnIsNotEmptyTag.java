...
/**
 * @author rb
 * @version $Id: IfColumnIsNotEmptyTag.java,v 1.1 2005/07/19 12:03:52 rb Exp $
 *
 */
public class IfColumnIsNotEmptyTag extends BnmBodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        if (cd != null && cd.getColumnValue() != null) {
            ...
            // Debug
            Debug.log("Column '" + name + "' not empty ('" +
